...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {7}{Algorithm Graham-Scan ($P$)}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {6}{function CHDC~($P = \{p_1, p_2, \cdots, p_n\}$)}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {24}{function combine~($C_1, C_2$)}\xxx
