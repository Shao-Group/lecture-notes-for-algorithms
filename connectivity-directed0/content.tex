...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {6}{Algorithm find-linearization ($G = (V, E)$)}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {6}{function DFS ($G = (V, E)$)}\xxx
	\aab {num-cc = 0;}\xxx
	\aaB {4}{for \textcolor{blue}{$v_i$ in a specific order}}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {4}{function explore ($G = (V, E), v_i \in V$)}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {4}{function DFS-with-timing ($G = (V, E)$)}\xxx
	\aab {$clock = 1$;}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {9}{function explore ($G = (V, E), v_i \in V$)}\xxx
	\aab {$visited[i] = 1$;}\xxx
	\aab {$pre[i] = clock$;}\xxx
	\aab {$clock++$;}\xxx
	\aaB {2}{for any edge $(v_i, v_j) \in E$}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
	\aaA {6}{function DFS ($G = (V, E)$)}\xxx
	\aab {num-cc = 0;}\xxx
	\aaB {4}{for \textcolor{blue}{$v_i$ in the $postlist$ obtained above}}\xxx
	\aaC {3}{if ($visited[i] = 0$)}\xxx
	\aad {num-cc = num-cc + 1;}\xxx
	\aad {explore ($G, v_j$);}\xxx
\end{algorithmblock}
