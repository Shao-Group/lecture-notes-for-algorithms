...
\begin{algorithmblock}[0.8\textwidth]
        \aaA {10}{function FFT($a_0, a_1, \cdots, a_{n-1}, \omega$)}\xxx
...
\begin{algorithmblock}[0.8\textwidth]
        \aaA {12}{function polynomial-multiplication($a=(a_0, a_1, \cdots, a_{n-1}), b=(b_0, b_1, \cdots, b_{n-1})$)}\xxx
