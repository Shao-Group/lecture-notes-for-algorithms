...
\begin{minipage}{0.8\textwidth}
	\aaA {10}{Algorithm DP-edit-distance~($X[1\cdots m]$, $Y[1\cdots n]$)}\xxx
	\aab {$F_1[j] = j$, for any $0 \le j \le n$}\xxx
	\aaB {6}{for $i = 1 \to m$}\xxx
	\aac {$F_2[0] = i$;}\xxx
...
\begin{minipage}{0.8\textwidth}
	\aaA {6}{Algorithm DC-optimal-alignment~($X[1\cdots m]$, $Y[1\cdots n]$)}\xxx
...
\begin{minipage}{0.8\textwidth}
	\aaA {7}{function find-middle~($X[1\cdots m]$, $Y[1\cdots n]$)}\xxx
